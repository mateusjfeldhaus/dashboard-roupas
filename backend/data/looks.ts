...
export const looks: Look[] = [
  ...
  // ── Looks com peças novas (abotoadura + calça vinho) ─────────────────────────

  {
    id: 'L189',
    title: 'Punho Francês Clássico',
    tags: ['formal', 'inverno', 'noturno'],
    formality: 5,
    tip: 'O punho francês exige abotoadura — é o único detalhe que separa o executivo do cavalheiro.',
    pieces: [
      { cat: 'Camisa',    pieceId: 'cs-br-hsa' },
      { cat: 'Acessório', pieceId: 'ac-ab' },
      { cat: 'Blazer',    pieceId: 'bl-pr-cli' },
      { cat: 'Calça',     pieceId: 'cl-ch-zeg' },
      { cat: 'Sapato',    pieceId: 'sa-pr-dem-d' },
      { cat: 'Cinto',     pieceId: 'ci-pr' },
  ...
  {
    id: 'L190',
    title: 'Brooksfield Azul Bebê',
    tags: ['formal', 'inverno', 'noturno'],
    formality: 5,
    tip: 'Fio 200 com punho francês e blazer royal: o look mais elegante do armário.',
    pieces: [
      { cat: 'Camisa',    pieceId: 'cs-ab-brk' },
      { cat: 'Acessório', pieceId: 'ac-ab' },
      { cat: 'Blazer',    pieceId: 'bl-azr-doc' },
  ...
  {
    id: 'L191',
    title: 'Vinho e Preto Noturno',
    tags: ['casual', 'outono', 'noturno'],
    formality: 3,
    tip: 'Calça vinho com preto no blazer e camisa — contraste sofisticado para jantar.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-pr-con' },
      { cat: 'Blazer',  pieceId: 'bl-pr-doc' },
      { cat: 'Calça',   pieceId: 'cl-vi-raf' },
      { cat: 'Sapato',  pieceId: 'sa-pr-dem-ch' },
      { cat: 'Cinto',   pieceId: 'ci-pr' },
      { cat: 'Relógio', pieceId: 're-pr-ori-b' },
    ],
  },
  {
    id: 'L192',
    title: 'Tonal Vinho',
    tags: ['formal', 'outono', 'noturno'],
    formality: 4,
    tip: 'Conjunto tonal vinho com camisa branca como âncora — impactante e coeso.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ba-doc' },
      { cat: 'Blazer',  pieceId: 'bl-vi-raf' },
      { cat: 'Calça',   pieceId: 'cl-vi-raf' },
  ...
  {
    id: 'L193',
    title: 'Vinho e Punho Francês',
    tags: ['formal', 'inverno', 'noturno'],
    formality: 5,
    tip: 'As duas peças novas juntas: calça vinho com punho francês e blazer chumbo.',
    pieces: [
      { cat: 'Camisa',    pieceId: 'cs-br-hsa' },
      { cat: 'Acessório', pieceId: 'ac-ab' },
      { cat: 'Blazer',    pieceId: 'bl-ch-doc' },
  ...
  // ── Blazer Bespoke Príncipe de Gales ─────────────────────────────────────────
  {
    id: 'L194',
  ...
  {
    id: 'L195',
    title: 'Príncipe de Gales e Azul',
    tags: ['formal', 'diurno', 'outono'],
    formality: 4,
    tip: 'Camisa azul escura ancorada pelo xadrez cinza — combinação do alfaiate inglês clássico.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ae-doc' },
      { cat: 'Blazer',  pieceId: 'bl-pg-bsp' },
      { cat: 'Calça',   pieceId: 'cl-ci-raf' },
  ...
  {
    id: 'L197',
    title: 'Príncipe de Gales e Jeans',
    tags: ['casual', 'diurno', 'outono'],
    formality: 2,
    tip: 'O blazer bespoke desestrutura o jeans preto — contraste entre formalidade e casualidade.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-br-doc' },
      { cat: 'Blazer',  pieceId: 'bl-pg-bsp' },
      { cat: 'Calça',   pieceId: 'cl-jp-lev' },
  ...
  {
    id: 'L198',
    title: 'Príncipe de Gales com Layer',
    tags: ['casual', 'inverno', 'diurno'],
    formality: 3,
    tip: 'Suéter preto sob o xadrez: o layering de inverno que qualquer inglês adotaria.',
    pieces: [
      { cat: 'Blazer',  pieceId: 'bl-pg-bsp' },
      { cat: 'Calça',   pieceId: 'cl-ch-zeg' },
      { cat: 'Suéter',  pieceId: 'su-pr-1' },
  ...
  },
  {
    ...
    pieces: [
      ...
      { cat: 'Acessório', pieceId: 'ac-ab' },
      { cat: 'Blazer',    pieceId: 'bl-pg-bsp' },
      { cat: 'Colete',    pieceId: 'co-pg-bsp' },
      { cat: 'Calça',     pieceId: 'cl-pg-bsp' },
      { cat: 'Gravata',   pieceId: 'gr-ma-ofr' },
      { cat: 'Cinto',     pieceId: 'ci-pr' },
      { cat: 'Sapato',    pieceId: 'sa-pr-maj-o' },
      { cat: 'Relógio',   pieceId: 're-pr-cit' },
  ...
  {
    id: 'L200',
    title: 'Príncipe de Gales e Polo',
    tags: ['casual', 'diurno', 'primavera'],
    formality: 2,
    tip: 'Polo creme sob o xadrez — o look do fim de semana europeu.',
    pieces: [
      { cat: 'Polo',    pieceId: 'po-cr' },
      { cat: 'Blazer',  pieceId: 'bl-pg-bsp' },
      { cat: 'Calça',   pieceId: 'cl-ar-doc' },
  ...
  {
    id: 'L201',
    title: 'Príncipe de Gales e Malha',
    tags: ['formal', 'inverno', 'noturno'],
    formality: 4,
    tip: 'Camisa vinho com xadrez cinza — tom quente que funciona bem no outono/inverno.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-vi-doc' },
      { cat: 'Blazer',  pieceId: 'bl-pg-bsp' },
      { cat: 'Calça',   pieceId: 'cl-pr-doc' },
  ...
  {
    id: 'L202',
    title: 'Príncipe de Gales e Rosa',
    tags: ['casual', 'diurno', 'primavera'],
    formality: 3,
    tip: 'Rosa linho com xadrez cinza: a combinação italiana que os ingleses nunca ousaram mas deveriam.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ro-cli' },
      { cat: 'Blazer',  pieceId: 'bl-pg-bsp' },
      { cat: 'Calça',   pieceId: 'cl-ci-raf' },
  ...
  {
    id: 'L203',
    title: 'Príncipe de Gales com Gola Alta',
    tags: ['casual', 'inverno', 'diurno'],
    formality: 3,
    tip: 'Gola alta preta sob o blazer xadrez: o visual de intelectual europeu que não precisa de gravata.',
    pieces: [
      { cat: 'Blazer',  pieceId: 'bl-pg-bsp' },
      { cat: 'Calça',   pieceId: 'cl-ch-raf' },
      { cat: 'Suéter',  pieceId: 'su-pr-ga' },
  ...
  // ── Calça Bespoke Príncipe de Gales ──────────────────────────────────────────
  {
    id: 'L204',
  ...
  {
    id: 'L205',
    title: 'Calça Xadrez com Azul Tropical',
    tags: ['formal', 'diurno', 'primavera'],
    formality: 4,
    tip: 'Calça xadrez cinza quebra o visual monocromático do blazer azul — resultado elegante e diferenciado.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-br-doc' },
      { cat: 'Blazer',  pieceId: 'bl-az-hsa' },
      { cat: 'Calça',   pieceId: 'cl-pg-bsp' },
  ...
  {
    id: 'L206',
    title: 'Calça Xadrez com Raffer Cinza',
    tags: ['formal', 'diurno', 'outono'],
    formality: 4,
    tip: 'Dois tons de cinza — um liso, um xadrez — separados por camisa azul. Jogo de texturas refinado.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ab-brk' },
      { cat: 'Blazer',  pieceId: 'bl-ci-raf' },
      { cat: 'Calça',   pieceId: 'cl-pg-bsp' },
  ...
  {
    id: 'L207',
    title: 'Calça Xadrez com Caramelo',
    tags: ['casual', 'diurno', 'outono'],
    formality: 3,
    tip: 'Caramelo e cinza xadrez: a combinação terra que só funciona bem com bespoke.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ba-doc' },
      { cat: 'Blazer',  pieceId: 'bl-ca-hsa' },
      { cat: 'Calça',   pieceId: 'cl-pg-bsp' },
  ...
  {
    id: 'L209',
    title: 'Calça Xadrez com Vinho',
    tags: ['formal', 'noturno', 'outono'],
    formality: 4,
    tip: 'Blazer vinho com calça xadrez: o look de galeria de arte que carrega personalidade e classe.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ba-doc' },
      { cat: 'Blazer',  pieceId: 'bl-vi-raf' },
      { cat: 'Calça',   pieceId: 'cl-pg-bsp' },
  ...
  {
    id: 'L210',
    title: 'Calça Xadrez Casual Inverno',
    tags: ['casual', 'inverno', 'diurno'],
    formality: 2,
    tip: 'Suéter petróleo com calça xadrez e sem blazer — visual orgânico de outono europeu.',
    pieces: [
      { cat: 'Calça',   pieceId: 'cl-pg-bsp' },
      { cat: 'Suéter',  pieceId: 'su-pe' },
      { cat: 'Sapato',  pieceId: 'sa-pr-dem-ch' },
  ...
  {
    id: 'L211',
    title: 'Calça Xadrez com Decinel',
    tags: ['formal', 'diurno', 'outono'],
    formality: 4,
    tip: 'Blazer marrom lã com calça xadrez cinza: terra e cinza, a paleta do outono inglês.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ba-doc' },
      { cat: 'Blazer',  pieceId: 'bl-ma-dec' },
      { cat: 'Calça',   pieceId: 'cl-pg-bsp' },
  ...
  {
    id: 'L212',
    title: 'Calça Xadrez com Punho Francês',
    tags: ['formal', 'diurno', 'inverno'],
    formality: 5,
    tip: 'Punho francês com calça xadrez bespoke — quando cada detalhe é pensado ao nível do alfaiate.',
    pieces: [
      { cat: 'Camisa',    pieceId: 'cs-br-hsa' },
      { cat: 'Acessório', pieceId: 'ac-ab' },
      { cat: 'Blazer',    pieceId: 'bl-ch-doc' },
  ...
  {
    id: 'L213',
    title: 'Calça Xadrez e Colete',
    tags: ['formal', 'diurno', 'outono'],
    formality: 4,
    tip: 'Calça e colete xadrez sem blazer: o waistcoat look de alfaiate inglês — sem o terceiro elemento, toda a atenção vai para o colete.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ba-doc' },
      { cat: 'Colete',  pieceId: 'co-pg-bsp' },
      { cat: 'Calça',   pieceId: 'cl-pg-bsp' },
  ...
  // ── Colete Bespoke Príncipe de Gales ─────────────────────────────────────────
  {
    id: 'L214',
  ...
  {
    id: 'L215',
    title: 'Três Peças Bespoke com Punho Francês',
    tags: ['formal', 'diurno', 'inverno'],
    formality: 5,
    tip: 'Punho francês sob o terno de 3 peças bespoke — a combinação mais completa e formal do guarda-roupa.',
    pieces: [
      { cat: 'Camisa',    pieceId: 'cs-br-hsa' },
      { cat: 'Acessório', pieceId: 'ac-ab' },
      { cat: 'Blazer',    pieceId: 'bl-pg-bsp' },
  ...
  {
    id: 'L216',
    title: 'Colete Xadrez com Chumbo',
    tags: ['formal', 'diurno', 'outono'],
    formality: 4,
    tip: 'Colete xadrez sob blazer liso chumbo — o padrão aparece como detalhe, não como personagem principal.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ba-doc' },
      { cat: 'Blazer',  pieceId: 'bl-ch-doc' },
      { cat: 'Colete',  pieceId: 'co-pg-bsp' },
  ...
  {
    id: 'L217',
    title: 'Waistcoat Inglês Clássico',
    tags: ['formal', 'diurno', 'outono'],
    formality: 4,
    tip: 'Colete sem blazer com camisa branca: o look de alfaiate que diz que você entende de roupa.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ba-doc' },
      { cat: 'Colete',  pieceId: 'co-pg-bsp' },
      { cat: 'Calça',   pieceId: 'cl-ch-raf' },
  ...
  {
    id: 'L218',
    title: 'Waistcoat com Calça Xadrez',
    tags: ['formal', 'diurno', 'outono'],
    formality: 4,
    tip: 'Colete e calça xadrez sem blazer — dois terços do terno criando um look de waistcoat com personalidade.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-az-cli' },
      { cat: 'Colete',  pieceId: 'co-pg-bsp' },
      { cat: 'Calça',   pieceId: 'cl-pg-bsp' },
  ...
  {
    id: 'L219',
    title: 'Colete Xadrez sob Preto',
    tags: ['formal', 'noturno', 'inverno'],
    formality: 4,
    tip: 'O xadrez aparece entre o blazer preto e a calça preta — detalhe sutil que só quem olha de perto percebe.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ba-doc' },
      { cat: 'Blazer',  pieceId: 'bl-pr-cli' },
      { cat: 'Colete',  pieceId: 'co-pg-bsp' },
  ...
  {
    id: 'L221',
    title: 'Colete Xadrez com Azul Tropical',
    tags: ['formal', 'diurno', 'primavera'],
    formality: 4,
    tip: 'Colete xadrez cinza sob blazer azul: o padrão e a cor se complementam sem competir.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-br-doc' },
      { cat: 'Blazer',  pieceId: 'bl-az-hsa' },
      { cat: 'Colete',  pieceId: 'co-pg-bsp' },
  ...
  {
    id: 'L222',
    title: 'Colete Xadrez Casual',
    tags: ['casual', 'diurno', 'outono'],
    formality: 3,
    tip: 'Sem gravata, sem blazer — só o colete xadrez com camisa azul e calça linho. Elegância sem esforço aparente.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ab-brk' },
      { cat: 'Colete',  pieceId: 'co-pg-bsp' },
      { cat: 'Calça',   pieceId: 'cl-ar-hsa' },
  ...
  {
    id: 'L223',
    title: 'Colete Xadrez com Zegna',
    tags: ['formal', 'diurno', 'inverno'],
    formality: 5,
    tip: 'O melhor tecido do guarda-roupa com o melhor padrão — Zegna e Príncipe de Gales numa combinação de colecionador.',
    pieces: [
      { cat: 'Camisa',  pieceId: 'cs-ba-doc' },
      { cat: 'Blazer',  pieceId: 'bl-ch-zeg' },
      { cat: 'Colete',  pieceId: 'co-pg-bsp' },
